 ...
 * <ul>
 *   <li>{@link org.eventb.emf.formulas.impl.IntegerLiteralExpressionImpl#getNumber <em>Number</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IntegerLiteralExpressionImpl extends BExpressionResolvedImpl implements IntegerLiteralExpression {
	/**
	...
	protected EClass eStaticClass() {
		return FormulasPackage.Literals.INTEGER_LITERAL_EXPRESSION;
	}
	...
	public void setNumber(BigInteger newNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormulasPackage.INTEGER_LITERAL_EXPRESSION__NUMBER, oldNumber, number));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormulasPackage.INTEGER_LITERAL_EXPRESSION__NUMBER:
				return getNumber();
		}
